...
const Kt = z("Zap", [
    ...
    U5 = () => {
        const { getThemeColors: e } = Re(), t = e();
        return u.jsx("section", {
            className: "min-h-screen flex items-center justify-center bg-black/60 page-transition",
            children: u.jsxs("div", {
                className: "text-center z-10 max-w-xl mx-auto w-full p-10 rounded-2xl border backdrop-blur-lg",
                style: { borderColor: `${t.primary}40`, background: `linear-gradient(135deg, ${t.primary}10, rgba(0,0,0,0.7))` },
                children: [
                    u.jsx("h1", {
                        className: "font-orbitron font-black text-4xl mb-6",
